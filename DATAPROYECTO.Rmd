...
```{r}
urbano[urbano$Pais=='Cura?ao (Netherlands)',"Pais"]="Curacao"
...
```
Por último procedemos a exportar la data a nuestro directorio
```{r}
library(rio)
export(urbano,"SOCIOURBAN1.csv")
```
